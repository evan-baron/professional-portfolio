...
const experience: Experience[] = [
	...
	},
	{
		...
		bullets: [
			'**Saved 30+ FTE hours per user per week** by building a custom email-automation platform with AI workflows, real-time CRUD operations, and a dynamic React UI.',
